 ...
 */
    ...
    private final String[] DECENAS = {"diez ", "once ", "doce ", "trece ", "catorce ", "quince ", "dieciseis ",
        "diecisiete ", "dieciocho ", "diecinueve", "veinte", "veintiuno","veintidos","veintitres","veinticuatro","veinticinco","veintiseis","veintisiete","veintiocho","veintinueve", "treinta ", "cuarenta ",
   ...
   public NumeroALetra() {
    ...
    public String Convertir(String numero, boolean mayusculas, String moneda) {
        ...
        if (Pattern.matches("\\d{1,9},\\d{1,2}", numero)) {
            ...
            if (mayusculas) {
                return (literal.trim() +" CON "+ parte_decimal).toUpperCase();
            } else {
                return (literal.trim() +" CON "+ parte_decimal);
            }
    ...
    public String convertirSoloNumero(String numero) {
        String literal = "";
        String parte_decimal;
        //si el numero utiliza (.) en lugar de (,) -> se reemplaza
        numero = numero.replace(".", ",");
    ...
    private String getDecenas(String num) {// 99
        ...
        if (n < 10) {//para casos como -> 01 - 09
            ...
            if (u.equals("")) { //para 30,40,50,60,70,80,90
                ...
                if(u.trim().equals("un")){
                    return DECENAS[Integer.parseInt(num.substring(0, 1)) + 17] + "y uno";
                }else{
    ...
    private String getMiles(String numero) {// 999 999
        ...
        if (Integer.parseInt(m) > 0) {
           ...
           }else if(n.trim().equals("veintiuno")){
             return "veintiún mil " + getCentenas(c);
           }else{
             return n.trim() + " mil " + getCentenas(c); 
           }
        } else {
