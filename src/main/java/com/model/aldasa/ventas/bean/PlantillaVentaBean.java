...
public class PlantillaVentaBean extends BaseBean {
	...
	public void saveVoucherTemp() {
		VoucherTemp busqueda = voucherTempService.findByPlantillaVentaAndMontoAndTipoTransaccionAndNumeroTransaccionAndFechaAndCuentaBancaria(plantillaVentaSelected, monto, tipoTransaccion, numeroTransaccion, fechaOperacion, cuentaBancariaSelected);
		if(busqueda != null) {
			...
			addErrorMessage("El voucher se añadió a datos temporales correctamente");
